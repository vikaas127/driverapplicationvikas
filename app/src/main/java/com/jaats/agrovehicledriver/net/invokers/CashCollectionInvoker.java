...
public class CashCollectionInvoker extends BaseInvoker {

    public CashCollectionInvoker() {
        super();
    }

    public CashCollectionInvoker(HashMap<String, String> urlParams,
                        JSONObject postData) {
        super(urlParams, postData);
    }

    public BasicBean invokeCashCollectionWS() {

        System.out.println("POSTDATA>>>>>>>" + postData);

        WebConnector webConnector;

        webConnector = new WebConnector(new StringBuilder(ServiceNames.TRIP_CONFIRM_CASH_COLLECTION),
